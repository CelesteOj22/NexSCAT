...
SECRET_KEY = 'django-insecure-#eqw8y+(p-0%u1_(dzap5l@9jn6i$m0by+js7=d2f40)@$tw*2'
...
# etiqueta static para el html
STATIC_URL = 'static/'

# Add this in your settings.py file:

# esto es en caso de que tenga distintas vistas que van a usar distintos css entonces no se referencia de valde
STATICFILES_DIRS = [
    BASE_DIR / 'static/',
]
